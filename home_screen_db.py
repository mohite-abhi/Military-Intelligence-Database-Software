...
class intel_ui(tk.Tk):
    def __init__(self):
        ...
        self.command = ""
        self.con = mysql.connect(host="localhost", user="tyson", password="421939", database="intel")
    ...
    def insert(self):
        ...
        for i in self.catched_rows:
            if count%2:
                ...
                tag = "odd"
            self.tv.insert('', 'end', values=(count:=count+1,)+tuple(i),tags=(tag,))
            a=len(i[3])
            if a > 100:
                no = math.floor(a/100)
    ...
    def crime_table(self):
        ...
        for i in self.catched_rows:
            if count%2:
                ...
                tag = "odd"
            self.tv.insert('', 'end', values=(count:=count+1,)+i[1:],tags=(tag,))
    ...
    def insert(self):
        ...
        for i in self.catched_rows:
            if count%2:
                ...
                tag = "odd"
            self.tv.insert('', 'end', values=(count:=count+1,)+(i[0],)+i[2:4]+i[7:11],tags=(tag,))
            count += 1
    ...
    def insert(self):
        ...
        for i in self.catched_rows:
            if count%2:
                ...
                tag = "odd"
            self.tv.insert('', 'end', values=(count:=count+1,)+(i[0],)+i[1:3],tags=(tag,))
